...
GOAL_CONTEXT = {
	...
	"G45": ("engine/platform/gamecube/in_gamecube.c", "engine/client/input.h",
		"engine/client/input/input.c", "scripts/gamecube-controller-compliance.py",
		"scripts/gamecube-rc-check.sh", "docs/GAMECUBE_HARDWARE_VALIDATION.md"),
	"G46": ("engine/server/sv_save.c", "engine/server/sv_cmds.c",
		"scripts/gamecube-save-compliance.py", "scripts/gamecube-rc-check.sh",
		"docs/GAMECUBE_HOMEBREW_COMPLIANCE.md"),
	"G47": ("engine/server/sv_init.c", "engine/platform/gamecube/sys_gamecube.c",
		"engine/client/cl_mod.c", "engine/common/cmd.c",
		"scripts/build-gamecube-disc.py", "scripts/ai-verify.sh"),
	"G48": ("engine/platform/gamecube/snddma_gamecube.c",
		"engine/client/sound/s_main.c", "engine/client/sound/s_load.c",
		"scripts/gamecube-audio-compliance.py", "scripts/gamecube-rc-check.sh",
	...
	"G53": ("docs/GAMECUBE_HARDWARE_VALIDATION.md",
		"docs/GAMECUBE_HARDWARE_MATRIX.md", "docs/GAMECUBE_PORT_PLAN.md",
	...
	"G55": ("scripts/build-gamecube.sh", "scripts/build-gamecube-disc.py",
		...
		".gitignore", "docs/GAMECUBE_PORT_PLAN.md",
		".ai/goals/GAMECUBE_PORT_GOALS.md"),
	"G56": ("docs/GAMECUBE_HARDWARE_VALIDATION.md",
		"docs/GAMECUBE_HOMEBREW_COMPLIANCE.md", "docs/GAMECUBE_PORT_PLAN.md",
		"docs/GAMECUBE_HARDWARE_BOOT_CHECKLIST.md",
	...
	"G69": ("scripts/dolphin-boot-probe.sh",
		...
		"engine/platform/gamecube/vid_gamecube.c",
		"engine/platform/gamecube/snddma_gamecube.c"),
	"G70": ("docs/GAMECUBE_HARDWARE_VALIDATION.md",
		"docs/GAMECUBE_HARDWARE_MATRIX.md",
		"docs/GAMECUBE_PORT_PLAN.md"),
	"G71": ("docs/GAMECUBE_HARDWARE_VALIDATION.md",
		"engine/server/sv_save.c", "engine/server/sv_cmds.c",
		"engine/common/filesystem_engine.c",
		"docs/GAMECUBE_PORT_PLAN.md"),
	"G72": ("engine/platform/gamecube/vid_gamecube.c",
		"engine/platform/gamecube/mem_gamecube.c"),
	"G83": ("engine/common/mod_bmodel.c", "ref/gx/r_main.c", "ref/gx/r_misc.c",
		"engine/platform/gamecube/vid_gamecube.c",
		"docs/GAMECUBE_PORT_PLAN.md"),
	"G84": ("engine/server/sv_phys.c", "engine/server/sv_main.c",
		"engine/common/host.c", "docs/GAMECUBE_PORT_PLAN.md"),
	"G85": ("engine/client/cl_scrn.c", "engine/platform/gamecube/vid_gamecube.c",
		"engine/platform/platform.h", "docs/GAMECUBE_PORT_PLAN.md"),
	"G86": ("engine/platform/gamecube/in_gamecube.c", "engine/server/sv_phys.c",
		"engine/client/cl_main.c", "docs/GAMECUBE_PORT_PLAN.md"),
	"G87": ("engine/server/sv_frame.c", "engine/server/sv_main.c",
		"engine/common/mod_bmodel.c", "docs/GAMECUBE_PORT_PLAN.md"),
	"G88": ("engine/server/sv_phys.c", "engine/server/sv_game.c",
		"engine/platform/gamecube/in_gamecube.c", "docs/GAMECUBE_PORT_PLAN.md"),
	...
	"G74": ("docs/GAMECUBE_PORT_PLAN.md",
		"docs/GAMECUBE_HARDWARE_VALIDATION.md",
		"docs/GAMECUBE_RELEASE_MANIFEST.md",
		".ai/goals/GAMECUBE_PORT_GOALS.md"),
	"G75": ("docs/GAMECUBE_HARDWARE_VALIDATION.md",
		"docs/GAMECUBE_HARDWARE_MATRIX.md",
		"docs/GAMECUBE_RELEASE_MANIFEST.md",
		"docs/GAMECUBE_PORT_PLAN.md",
		".ai/goals/GAMECUBE_PORT_GOALS.md"),
...
GOAL_CONTEXT_SLICES = {
	...
	"G83": (
		("engine/common/mod_bmodel.c",),
		("ref/gx/r_main.c", "ref/gx/r_misc.c"),
	),
	"G84": (
		("engine/server/sv_phys.c",),
		("engine/server/sv_main.c", "engine/common/host.c"),
	),
	"G85": (
		("engine/client/cl_scrn.c", "engine/platform/gamecube/vid_gamecube.c"),
	),
	"G86": (
		("engine/platform/gamecube/in_gamecube.c",),
		("engine/server/sv_phys.c", "engine/client/cl_main.c"),
	),
	"G87": (
	...
	"G88": (
		("engine/server/sv_phys.c", "engine/platform/gamecube/in_gamecube.c"),
	),
	"G82": (
		("engine/platform/gamecube/vid_gamecube.c",),
		("engine/platform/gamecube/sys_gamecube.c",),
...
GOAL_READ_CONTEXT = {
	...
	"G67": (".ai/prompts/GOLDSRC_CONTENT_FORMATS.md",
		".ai/prompts/GAMECUBE_STORAGE_NOTES.md",
		".ai/prompts/GAMECUBE_MEMORY_BUDGET.md"),
	"G68": (".ai/prompts/GOLDSRC_CONTENT_FORMATS.md",
		".ai/prompts/GAMECUBE_LOCAL_EXAMPLES.md",
		".ai/prompts/GAMECUBE_MEMORY_BUDGET.md"),
	"G69": (".ai/prompts/GAMECUBE_MEMORY_BUDGET.md",
		".ai/prompts/GAMECUBE_GX_RENDERING_NOTES.md",
		".ai/prompts/GAMECUBE_AUDIO_NOTES.md"),
	"G70": (".ai/prompts/GAMECUBE_HARDWARE_NOTES.md",
		".ai/prompts/GAMECUBE_HOMEBREW_COMPLIANCE.md"),
	"G71": (".ai/prompts/GAMECUBE_STORAGE_NOTES.md",
		".ai/prompts/GAMECUBE_HARDWARE_NOTES.md",
		".ai/prompts/GAMECUBE_HOMEBREW_COMPLIANCE.md"),
	"G72": (),
	"G83": (".ai/prompts/GAMECUBE_MEMORY_BUDGET.md",
		".ai/prompts/GAMECUBE_GX_RENDERING_NOTES.md",
		".ai/prompts/GAMECUBE_FAILURE_MEMORY.md"),
	"G84": (".ai/prompts/GOLDSRC_SDK_NOTES.md",
		".ai/prompts/GAMECUBE_MEMORY_BUDGET.md"),
	"G85": (".ai/prompts/GAMECUBE_GX_RENDERING_NOTES.md",
		".ai/prompts/GAMECUBE_LOCAL_MISSION.md"),
	"G86": (".ai/prompts/GAMECUBE_HARDWARE_NOTES.md",
		".ai/prompts/PORTING_PATTERNS.md"),
	"G87": (".ai/prompts/GAMECUBE_NETWORKING_NOTES.md",
		".ai/prompts/GAMECUBE_MEMORY_BUDGET.md"),
	"G88": (".ai/prompts/GOLDSRC_SDK_NOTES.md",
		".ai/prompts/GAMECUBE_LOCAL_EXAMPLES.md"),
	"G82": (),
...
GOAL_COMMIT_SUBJECT = {
	...
	"G69": "test: add GameCube sustained soak gate",
	...
	"G83": "fix: GameCube BSP PointInLeaf and PVS",
	"G84": "fix: restore post-G36 entity think",
	"G85": "fix: sustain New Game world presents",
	"G86": "fix: New Game player move and look",
	"G87": "fix: post-G36 WriteEntities snapshots",
	"G88": "fix: first New Game world interaction",
