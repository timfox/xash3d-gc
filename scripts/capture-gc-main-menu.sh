...
export DOLPHIN_REQUIRE_MENU_ACTIONS=1
export DOLPHIN_TIMEOUT="${DOLPHIN_MENU_TIMEOUT:-150}"
export GC_BOOT_PROBE_TIMEOUT="${GC_BOOT_PROBE_TIMEOUT:-450}"
unset DOLPHIN_NEWGAME
unset DOLPHIN_SMOKE_MAP
unset DOLPHIN_WORLD_RENDER
set +e
