...
uint S_RawSamplesStereoFrac( portable_samplepair_t *rawsamples, uint rawend, uint max_samples, uint samples, uint rate, word width, word channels, const byte *data, uint *samplefrac );
uint S_RawSamplesStereoFracTimed( portable_samplepair_t *rawsamples, uint rawend, uint min_rawend, uint max_samples, uint samples, uint rate, word width, word channels, const byte *data, uint *samplefrac );
