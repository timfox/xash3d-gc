...
- Generated: 2026-07-26T21:35:23.579934+00:00
...
- **.text** (code): 0 bytes (0.00 KiB)
- **.data** (initialized): 0 bytes (0.00 KiB)
- **.rodata** (read-only): 0 bytes (0.00 KiB)
- **.bss** (uninitialized): 0 bytes (0.00 MiB)
- **Total section size**: 0 bytes (0.00 MiB)
